...
if (isset($_POST['cargo-submit'])) {
    ...
    //Validate contact address is valid
    if(!is_int($scontact)){
        //Update error with inavlid sender address
        $error = 'Invalid sender address!';
    }
    //End validation of sender address
    if (!($scity == $rcity)) {

        if (1) {

            if (($scity == 'Dhaka' && $rcity == 'sagana') || ($scity == 'sagana' && $rcity == 'Dhaka')) {
                $basic_price = 1500;
            } else if (($scity == 'Dhaka' && $rcity == 'sololo') || ($scity == 'sololo' && $rcity == 'Dhaka')) {
                $basic_price = 1200;
            } else if (($scity == 'Dhaka' && $rcity == 'meeru') || ($scity == 'meeru' && $rcity == 'Dhaka')) {
                $basic_price = 700;
            } else if (($scity == 'Dhaka' && $rcity == 'marsabit') || ($scity == 'marsabit' && $rcity == 'Dhaka')) {
                $basic_price = 900;
            } else if (($scity == 'Dhaka' && $rcity == 'nanyuki') || ($scity == 'nanyuki' && $rcity == 'Dhaka')) {
                $basic_price = 800;
            } else if (($scity == 'Dhaka' && $rcity == 'isiolo') || ($scity == 'isiolo' && $rcity == 'Dhaka')) {
                $basic_price = 1000;
            } else if (($scity == 'Dhaka' && $rcity == 'embu') || ($scity == 'embu' && $rcity == 'Dhaka')) {
                $basic_price = 600;
            }
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="form4Example1" class="form-control" name="sname" placeholder="Sender's Name" value="<?= isset($sname) ? $sname : '' ?>" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="email" id="form4Example2" class="form-control" name="semail" placeholder="Sender's Email" value="<?= isset($semail) ? $semail : '' ?>" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="form4Example3" rows="4" name="scontact" placeholder="Sender's Contact Number" pattern="01[3|5|6|7|8|9][0-9]{8}" value="<?= isset($scontact) ? $scontact : '' ?>" required></input>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="form4Example3" rows="4" name="saddress" placeholder="Sender's Address" value="<?= isset($saddress) ? $saddress : '' ?>" required></input>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="form4Example1" class="form-control" name="rname" placeholder="Receiver's Name" value="<?= isset($rname) ? $rname : '' ?>" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="email" id="form4Example2" class="form-control" name="remail" placeholder="Receiver's Email" value="<?= isset($remail) ? $remail : '' ?>" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="form4Example3" rows="4" name="rcontact" placeholder="Receiver's Contact Number" pattern="01[3|5|6|7|8|9][0-9]{8}" value="<?= isset($rcontact) ? $rcontact : '' ?>" required></input>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="form4Example3" rows="4" name="raddress" placeholder="Receiver's Address" value="<?= isset($raddress) ? $raddress : '' ?>" required></input>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="form4Example1" class="form-control" name="cweight" placeholder="Cargo's Weight in Kilogram" value="<?= isset($cweight) ? $cweight : '' ?>" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" id="form4Example1" class="form-control" name="cquantity" placeholder="Cargo's Quantity" value="<?= isset($cquantity) ? $cquantity : '' ?>" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="date" id="form4Example1" class="form-control" name="cdate" placeholder="Order Date" value="<?= isset($cdate) ? $cdate : '' ?>" required />
                                </div>
                            </div>
                        </div>
