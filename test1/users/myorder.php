                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?= isset($price_row['total_price']) ? $price_row['total_price'] . ' ksh' : 'N/A' ?>
                                </td>

                                <!-- Show status if available -->
                                <td>
                                    <?= isset($tracking_row['status']) ? ucwords($tracking_row['status']) : 'N/A' ?>
                                </td>
                            </tr>
                        <?php
                        }
