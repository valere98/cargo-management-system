...
$result = mysqli_query($connect, "SELECT * FROM `price` WHERE `user_id` = '$user_id' ");
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" id="form4Example1" class="form-control" name="amount" placeholder="Enter The Given Amount" required />
                                </div>
                            </div>
                        </div>
